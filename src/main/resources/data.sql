...
insert ignore into category(name) VALUES ('tecknologie');
insert ignore into category(name) VALUES ('computers');
...
INSERT ignore INTO ecommerce_pff.product_img (is_primary_img, path, product_id) VALUES ( false, '/images/products/3be35654-ec4d-4856-b3fb-f520b64e8fa2.jpeg', 'ba3e610c-8b64-4cf9-939a-d8314d41ae16');
INSERT ignore INTO ecommerce_pff.product_img (is_primary_img, path, product_id) VALUES (true, '/images/products/3b635c07-d3f0-4ca7-baf9-3daa651a6924.svg', 'aa4e43ab-a6e9-4506-aa8c-aace21d3f78f');
INSERT ignore INTO ecommerce_pff.product_img (is_primary_img, path, product_id) VALUES (true, '/images/products/b72d13cc-c005-42e8-b614-ed9c4bcf2557.svg', 'd342e1e5-0a71-489e-b2bb-b093a857a966');
